...
//
  ...
  if(freq>=3000000){ //-------------------freq>=3MHz--------------------------------------------------
    ...
    if(FL!=oFL){
      ...
      cmd_si5351(18,0x4F);      // Enable CLK2 (MS2=Integer Mode, Source=PLL_A)
    }
    ...
    if(FL!=oFL){
      ...
      cmd_si5351(18,0x0F);      // Enable CLK2 (MS2=Fractional Mode, Source=PLL_A)
...
void si5351_init(void){
    ...
    cmd_si5351(18,0x4F);      // Enable CLK2 (MS1=Integer Mode, Source=PLL_A)
    cmd_si5351(177,0xA0);     // Reset PLL_A and B
    delay(10);
    set_freq(10000000);
    cmd_si5351(177,0x20);   // Reset PLLA
