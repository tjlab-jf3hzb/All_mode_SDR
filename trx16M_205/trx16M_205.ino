...
ver. 2.04  Jan.  5, 2026  Bug fix. Thank you for JS2JIA's contribution.
ver. 2.05  Jan.  8, 2026  S-meter frame added
...
void setup(void) {
  ...
  //for(int i=0; i<=Nstfft; i++)  // Jan. 5, 2026
